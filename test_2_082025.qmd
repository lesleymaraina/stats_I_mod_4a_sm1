...
- define hypothesis testing and its role in statistical inference
- formulate null and alternative hypotheses
- explain how test statistics and p-values are used to evaluate evidence against the null hypothesis
- interpret hypothesis test results in the context of a scientific question
:::
---
...
Next step: find p-value associated with test statistic
:::
...
- right tailed p-value for z = 2.8: `1 - pnorm(2.8) = 0.0026`
- p-value is the tail area under the null distribution beyond the observed test statistic
